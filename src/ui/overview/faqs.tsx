...
const Accordion_list = [
    {
        id: 1,
        title: 'What is mumblechat?',
        text: 'In short, mumblechat is the Whatsapp for Web3. Our chat app allows crypto wallet owners to message each other, and our integration toolkit allows Dapps to add a great communication experience to their products fast.'
    },
    {
        id: 2,
        title: 'Which blockchain can I log in to mumblechat with?',
    ...
    {
        id: 3,
        title: 'How does mumblechat deliver messages between wallets?',
    ...
    {
        id: 5,
        title: 'What are mumblechat points?',
...
const Faqs = () => {
    ...
    return (
        <StyledBox>
            <Box sx={{
                textAlign: 'left', margin: '4rem 0rem 0rem 0rem',
