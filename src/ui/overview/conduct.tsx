...
import token from '../../icons/home/token.svg'
        ...
        <>
            <Box>
                ...
                <Box className={classes.text__box}>
                    <Text text={"MumbleChat has a supply of 200 millions MMCT, a testament to"} />
                    <Text text={"its exclusivity and value preservation."} />
                </Box>
                <Box className={classes.token__box}>
                    <Image className={classes.token_img} src={token} alt={""} />
                </Box>
                    ...
                    <Box className={classes.list} component={'ul'}>
                        <Box className={classes.listItem_wrp} component={'li'}>
                            <Box className={classes.listItem}>
                                ...
                                <Typography className={classes.icotext} variant="h6" fontFamily={'Bruce Forever !important'}>ICO (35%)</Typography>
                            </Box>
                            <Box className={classes.ico_box}>
                                <Typography fontFamily={'Bruce Forever !important'}>Use of ICO Funds</Typography>
                        ...
                        <Box className={classes.listItem_wrp} component={'li'}>
                            <Box className={classes.listItem}>
                                ...
                                <Typography className={classes.icotext} variant="h6" fontFamily={'Bruce Forever !important'}>Community Rewards (40%)</Typography>
                            </Box>
                        </Box>
                        <Box className={classes.listItem_wrp} component={'li'}>
                            <Box className={classes.listItem}>
                                <Box className={classes.empty_box} bgcolor={'#094813'}></Box>
                                <Typography className={classes.icotext} variant="h6" fontFamily={'Bruce Forever !important'}>Future Development & Operations (15%)</Typography>
                            </Box>
                        </Box>
                        <Box className={classes.listItem_wrp} component={'li'}>
                            <Box className={classes.listItem}>
                                <Box className={classes.empty_box} bgcolor={'#B448E6'}></Box>
                                <Typography className={classes.icotext} variant="h6" fontFamily={'Bruce Forever !important'}>Team & Advisors (5%)</Typography>
                            </Box>
                        </Box>
                        <Box className={classes.listItem_wrp} component={'li'}>
                            <Box className={classes.listItem}>
                                <Box className={classes.empty_box} bgcolor={'#CAC103'}></Box>
                                <Typography className={classes.icotext} variant="h6" fontFamily={'Bruce Forever !important'}>Ecosystem Growth (2.5%)</Typography>
                            </Box>
                        </Box>
                        <Box className={classes.listItem_wrp} component={'li'}>
                            <Box className={classes.listItem}>
                                <Box className={classes.empty_box} bgcolor={'#6410D0'}></Box>
                                <Typography className={classes.icotext} variant="h6" fontFamily={'Bruce Forever !important'}>Liquidity Provision (2.5%)</Typography>
                            </Box>
                        </Box>
                        <Box className={classes.listItem_wrp} component={'li'}>
