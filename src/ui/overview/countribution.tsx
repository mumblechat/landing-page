...
import mobview from '../../icons/home/mobview.svg';
        ...
        <>
            <Box>
                ...
                <Box className={classes.text__box}>
                    <Text text={"Join the MumbleChat crypto Private Sale, engage with the project, and see your contribution"} />
                ...
                <Box className={classes.view__mobile}>
                    <Image className={classes.view__img} src={mobview} alt={""} />
                </Box>
            </Box>
        </>
    )
